...
$('a[href*=\'' + location.pathname.split('/dist/').reverse()[0] + '\']').addClass('current');

window.addEventListener('load',function (){
    const model = new PostsModel([
        new Post('React', 'Lorem ipsum dolor sit amet, consectetur adipisicing elit.'),
        new Post('Vue', 'Lorem ipsum dolor sit amet, consectetur adipisicing elit.'),
    ])
